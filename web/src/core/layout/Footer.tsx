...
import { Logo, Twitter, Discord, Twitch } from '@/core/components/icons';
            ...
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-12">
                    <div className="col-span-2">
                        <Link to={ROUTES.HOME} className="flex items-center gap-2 font-bold text-xl mb-4">
                ...
                <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-slate-500">
                    ...
                    <div className="flex gap-6">
                        <a href="https://twitter.com/make4gamers" target="_blank" rel="noopener noreferrer" className="hover:text-indigo-400 transition-colors"><Twitter className='h-4 w-4' /></a>
                        <a href="https://discord.gg/make4gamers" target="_blank" rel="noopener noreferrer" className="hover:text-indigo-400 transition-colors"><Discord className='h-4 w-4' /></a>
                        <a href="https://twitch.tv/make4gamers" target="_blank" rel="noopener noreferrer" className="hover:text-indigo-400 transition-colors"><Twitch className='h-4 w-4' /></a>
                    </div>
                </div>
            </div>
        </footer>
