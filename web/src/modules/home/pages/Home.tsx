...
import { GameCard } from '@/modules/games/components';
...
export default function Home() {
    ...
    const popularGames = [...gamesData].sort((a, b) => b.players - a.players).slice(0, 4);
            ...
            <section className="bg-linear-to-b from-indigo-950/20 to-slate-950 py-12 mb-8">
                <div className="container mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        {popularGames.map(game => (<GameCard key={game.id} {...game} />))}
                    </div>
                </div>
            </section>
            ...
            <section className="container mx-auto px-4 mb-8">
                <div className="bg-slate-900 rounded-xl p-6 border border-slate-800">
                    <div className="relative mb-6">
                        ...
                        <input type="text" placeholder={t('home.search')} value={searchTerm}
                    ...
                    <div>
                        <div>
                            <label className="block text-sm font-medium text-slate-400 mb-2">{t('home.filters.category')}</label>
