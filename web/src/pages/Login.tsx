...
export default function Login() {
  ...
  // NUEVO ESTADO: Interruptor para el Modo Invitado
  ...
  const handleEntrarComoInvitado = () => {
    // Aquí simplemente navegamos a la home. Como no hay usuario en Supabase,
    // el sistema ya lo considerará un "visitante/invitado" automáticamente.
    navigate('/');
  };
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-8 relative">
        ...
        <div className="relative w-full max-w-md">
          <div className="bg-slate-900/80 backdrop-blur-xl border border-slate-800 rounded-2xl p-8 shadow-2xl transition-all duration-300">
            ...
            {/* CONDICIONAL: ¿Mostramos Login normal o Aviso de Invitado? */}
